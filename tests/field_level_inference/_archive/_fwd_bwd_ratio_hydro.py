...
def cfg_of(forcing, backward):
    return SimulationConfig(solver_mode=FINITE_DIFFERENCE, mhd=False, progress_bar=False,
...
s0=build(finalize_config(cg,(11,)+sh),rv,jnp.ones(sh)*RHO0,(z,z,z),jnp.ones(sh)*P0,(z,z,z))
