...
# =============== ↓ Fourier-based analytical gradients ↓ ======
...
def run_adjoint_test(dim, ic_type):
    ...
    state_plot_path = str(figures_dir / f'state_evolution_{dim}d_{ic_type}.png')
    ...
    fig.tight_layout()
    grad_plot_path = str(figures_dir / f'gradient_{dim}d_{ic_type}.png')
...
def run_gradient_convergence_test():
    ...
    plot_path = str(figures_dir / "gradient_convergence_test.png")
...
def run_3d_mass_matrix_comparison(N=16):
    ...
    fig.tight_layout()
    plot_path = str(figures_dir / f"mass_matrix_comparison_3d_N{N}.png")
